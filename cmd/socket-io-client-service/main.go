...
// go run ./cmd/socketio-client-service/main.go
// swag init -g cmd/socketio-client-service/main.go -o doc/openapi
// go build -o ./bin/socketio-client-service ./cmd/socketio-client-service
// ./bin/socketio-client-service
