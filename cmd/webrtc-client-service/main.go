...
// go run ./cmd/webrtc-client-service/main.go
// swag init -g cmd/webrtc-client-service/main.go -o doc/openapi
// go build -o ./bin/webrtc-client-service ./cmd/webrtc-client-service
// ./bin/webrtc-client-service
...
func startGinServer() {
	...
	route.SetupRestfulWebRTCClientRoutes(ctx, router, host, port, logger, helloService, healthService, webrtcClientService)
	// route.SetupGraphQLRoutes(ctx, router, host, port, logger, authService, userService, teamService, helloService, healthService, webrtcClientService)
...
func main() {
	...
	// Create the webrtc client service
	webrtcClientService = service.NewWebRTCClientService(ctx, logger)
