...
func SetupRestfulRedisClientRoutes(ctx context.Context, r *gin.Engine, host string, port string, logger *logrus.Logger, helloService *service.HelloService, healthService *service.HealthService, redisClientService *service.RedisClientService) {
	...
	docGroup := r.Group("/doc")
	{
		...
		// openapiDocs.SwaggerInforedis_consumer_service.BasePath = "/"
