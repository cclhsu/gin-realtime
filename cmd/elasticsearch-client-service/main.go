...
// go run ./cmd/elasticsearch-client-service/main.go
// swag init -g cmd/elasticsearch-client-service/main.go -o doc/openapi
// go build -o ./bin/elasticsearch-client-service ./cmd/elasticsearch-client-service
// ./bin/elasticsearch-client-service
...
func startGinServer() {
	...
	route.SetupRestfulElasticsearchClientRoutes(ctx, router, host, port, logger, helloService, healthService, elasticsearchClientService)
	// route.SetupGraphQLRoutes(ctx, router, host, port, logger, authService, userService, teamService, helloService, healthService, elasticsearchClientService)
...
func main() {
	...
	elasticsearchClientService = service.NewElasticsearchClientService(ctx, logger)
