...
// go run ./cmd/elasticsearch-server-service/main.go
// swag init -g cmd/elasticsearch-server-service/main.go -o doc/openapi
// go build -o ./bin/elasticsearch-server-service ./cmd/elasticsearch-server-service
// ./bin/elasticsearch-server-service
...
func startGinServer() {
	...
	route.SetupRestfulElasticsearchServerRoutes(ctx, router, host, port, logger, helloService, healthService, elasticsearchServerService)
	// route.SetupGraphQLRoutes(ctx, router, host, port, logger, authService, userService, teamService, helloService, healthService, elasticsearchServerService)
...
func main() {
	...
	// Create the elasticsearch server service
	elasticsearchServerService = service.NewElasticsearchServerService(ctx, logger)
