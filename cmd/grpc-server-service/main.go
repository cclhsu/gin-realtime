...
// go run ./cmd/grpc-server-service/main.go
// swag init -g cmd/grpc-server-service/main.go -o doc/openapi
// go build -o ./bin/grpc-server-service ./cmd/grpc-server-service
...
func startGinServer() {
	...
	route.SetupRestfulGrpcServerRoutes(router, host, port, logger, helloService, healthService)
