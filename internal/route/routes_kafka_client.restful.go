...
func SetupRestfulKafkaClientRoutes(ctx context.Context, r *gin.Engine, host string, port string, logger *logrus.Logger, helloService *service.HelloService, healthService *service.HealthService, kafkaClientService *service.KafkaClientService) {
	...
	docGroup := r.Group("/doc")
	{
		...
		// openapiDocs.SwaggerInfokafka_consumer_service.BasePath = "/"
