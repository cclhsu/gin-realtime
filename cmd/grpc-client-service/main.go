...
// go run ./cmd/grpc-client-service/main.go
// swag init -g cmd/grpc-client-service/main.go -o doc/openapi
// go build -o ./bin/grpc-client-service ./cmd/grpc-client-service
// ./bin/grpc-client-service
...
func startGinServer() {
	...
	route.SetupRestfulGrpcClientRoutes(ctx, router, host, port, logger, helloService, healthService, grpcClientService)
	// route.SetupGraphQLRoutes(ctx, router, host, port, logger, authService, userService, teamService, helloService, healthService, grpcClientService)
...
func main() {
	...
	grpcClientService = service.NewGrpcClientService(ctx, logger)
