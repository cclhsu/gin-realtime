...
// go run ./cmd/kafka-producer-service/main.go
// swag init -g cmd/kafka-producer-service/main.go -o doc/openapi
// go build -o ./bin/kafka-producer-service ./cmd/kafka-producer-service
...
func startGinServer() {
	...
	route.SetupRestfulKafkaServerRoutes(ctx, router, host, port, logger, helloService, healthService, kafkaServerService)
	// route.SetupGraphQLRoutes(ctx, router, host, port, logger, authService, userService, teamService, helloService, healthService, kafkaServerService)
