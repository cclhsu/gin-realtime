...
// go run ./cmd/graphql-client-service/main.go
// swag init -g cmd/graphql-client-service/main.go -o doc/openapi
// go build -o ./bin/graphql-client-service ./cmd/graphql-client-service
// ./bin/graphql-client-service
...
func startGinServer() {
	...
	route.SetupRestfulGraphQLClientRoutes(ctx, router, host, port, logger, helloService, healthService, graphQLClientService)
	// route.SetupGraphQLRoutes(ctx, router, host, port, logger, authService, userService, teamService, helloService, healthService, redisServerService, websocketServerService)
...
func main() {
	...
	// Create the graphql client service
	graphQLClientService = service.NewGraphQLClientService(ctx, logger)
