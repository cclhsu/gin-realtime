...
// go run ./cmd/webrtc-server-service/main.go
// swag init -g cmd/webrtc-server-service/main.go -o doc/openapi
// go build -o ./bin/webrtc-server-service ./cmd/webrtc-server-service
...
func startGinServer() {
	...
	route.SetupRestfulWebRTCServerRoutes(ctx, router, host, port, logger, helloService, healthService, webrtcServerService)
	// route.SetupGraphQLRoutes(ctx, router, host, port, logger, authService, userService, teamService, helloService, healthService, webrtcServerService)
...
func main() {
	...
	// Create the webrtc server service
	webrtcServerService = service.NewWebRTCServerService(ctx, logger)
