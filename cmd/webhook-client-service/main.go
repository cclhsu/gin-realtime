...
// go run ./cmd/webhook-client-service/main.go
// swag init -g cmd/webhook-client-service/main.go -o doc/openapi
// go build -o ./bin/webhook-client-service ./cmd/webhook-client-service
// ./bin/webhook-client-service
