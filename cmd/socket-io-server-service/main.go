...
// go run ./cmd/socketio-server-service/main.go
// swag init -g cmd/socketio-server-service/main.go -o doc/openapi
// go build -o ./bin/socketio-server-service ./cmd/socketio-server-service
// ./bin/socketio-server-service
...
func startGinServer() {
	...
	route.SetupRestfulSocketIOServerRoutes(ctx, router, host, port, logger, helloService, healthService, socketioServerService)
	// route.SetupGraphQLRoutes(ctx, router, host, port, logger, authService, userService, teamService, helloService, healthService, socketioServerService)
...
func main() {
	...
	// Create the socket.io server service
	socketioServerService = service.NewSocketIOServerService(ctx, logger)
